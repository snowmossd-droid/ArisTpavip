...
public class GuiUtil {
    ...
    public static Inventory buildSenderGui(ArisTpa plugin, TpaRequest request) {
    ...
    public static Inventory buildAcceptGui(ArisTpa plugin, TpaRequest request) {
        int size = plugin.getConfig().getInt("gui.size", 27);
        String title = plugin.getConfig().getString("gui.title", "Confirm Request");
        Inventory inv = Bukkit.createInventory(null, size, MM.deserialize(title));
    ...
    private static void placeItem(ArisTpa plugin, Inventory inv, String path, UnaryOperator<String> replacer) {
    ...
    private static void placeHead(ArisTpa plugin, Inventory inv, Player player) {
